...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=KARVEX_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=KARVEX_BUILD_ID");
    println!("cargo:rerun-if-env-changed=KARVEX_BUILD_COMMIT");
