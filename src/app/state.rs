...
pub struct ToastNotification {
    ...
    pub title: String,
    pub context: String,
    pub position: Option<crate::config::ToastKarvexPosition>,
...
pub struct AppState {
    ...
    /// Capture mouse input for Karvex's own mouse UI. When false, Karvex only
    ...
    /// Installed or linked plugins known to this running Karvex instance.
...
impl AppState {
    ...
    pub fn test_new() -> Self {
        Self {
            ...
            worktree_directory: std::path::PathBuf::from("/tmp/karvex-worktrees"),
            ...
            update_install_command: "kvx update".into(),
