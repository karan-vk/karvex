...
"##,
    ...
    async fn all_workspaces_agent_panel_entries_use_live_root_runtime_cwd_for_workspace_label() {
        let unique = format!(
            "karvex-agent-panel-runtime-cwd-{}-{}",
            std::process::id(),
        ...
        assert_eq!(primary_label, "karvex");
    }
    ...
    fn grouped_child_label_uses_short_branch_for_auto_named_workspace() {
        assert_eq!(
            grouped_child_display_label("karvex-issue", Some("worktree/issue-137"), false),
            "issue-137"
        );
    }
    ...
    fn desktop_worktree_tree_aligns_parents_and_marks_children() {
        ...
        app.workspaces = vec![
            workspace_with_worktree_space("main", Some("repo-key"), "/repo/karvex"),
            workspace_with_worktree_space("issue", Some("repo-key"), "/repo/karvex-issue"),
            workspace_with_worktree_space("review", Some("repo-key"), "/repo/karvex-review"),
    ...
    fn compact_space_group_scroll_clamps_when_all_entries_fit() {
        ...
        app.workspaces = vec![
            workspace_with_worktree_space("main", Some("repo-key"), "/repo/karvex"),
            workspace_with_worktree_space("one", Some("repo-key"), "/repo/karvex-one"),
            workspace_with_worktree_space("two", Some("repo-key"), "/repo/karvex-two"),
        ];
        let area = Rect::new(0, 0, 30, 20);
