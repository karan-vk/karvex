{
  description = "karvex — terminal workspace manager for AI coding agents";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        let
          pkgs = pkgsFor system;
          karvex = pkgs.callPackage ./nix/package.nix {
      ...
      apps = forAllSystems (system: {
        default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/kvx";
          meta.description = "Run Karvex";
        };
      });

      checks = forAllSystems (system: {
        karvex = self.packages.${system}.default;
        default = self.checks.${system}.karvex;
      });
      ...
      overlays.default = lib.composeExtensions rust-overlay.overlays.default (
        final: _prev: {
          karvex = final.callPackage ./nix/package.nix {
