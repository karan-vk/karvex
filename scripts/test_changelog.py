...
class ChangelogScriptTests(unittest.TestCase):
    ...
    def test_build_latest_json_embeds_notes_and_release_assets(self) -> None:
        ...
        self.assertEqual(
            manifest["assets"],
            {
                "linux-x86_64": "https://github.com/herdrdev/herdr/releases/download/v0.1.1/kvx-linux-x86_64",
                "linux-aarch64": "https://github.com/herdrdev/herdr/releases/download/v0.1.1/kvx-linux-aarch64",
                "macos-x86_64": "https://github.com/herdrdev/herdr/releases/download/v0.1.1/kvx-macos-x86_64",
                "macos-aarch64": "https://github.com/herdrdev/herdr/releases/download/v0.1.1/kvx-macos-aarch64",
            },
        )
    ...
    def test_load_product_announcement_rejects_missing_file(self) -> None:
        path = Path(tempfile.gettempdir()) / "karvex-missing-product-announcement.json"
        path.unlink(missing_ok=True)
